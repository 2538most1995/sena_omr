...
- บันทึกเฉลยและคำนวณคะแนน
- เก็บเฉลยแยกตามรายวิชา และเก็บคะแนนแยกตามรายวิชา/กลุ่มเรียน
...
- บันทึกคะแนนที่ตรวจเสร็จไว้ในเครื่อง และส่งต่อไป API ภายนอกได้เมื่อมี endpoint สำหรับรับคะแนน
...
`POST /api/scores` จะบันทึกหรืออัปเดตผลใน `.run/omr_scores.sqlite3` เสมอ
